  ...
  render () {
    return (
      <section className="post">
        <h1 className="post__title">A post about priorities and scheduling</h1>
        <a href="#" className="post__link">http://example.com/post</a>
...
ReactDOM.render(<App/>, post.parentNode);
